...
{
    public partial class EquiposDisponibleStock : Form
    {
        public EquiposDisponibleStock()
        {
            InitializeComponent();
        }

        private void EquiposDisponibleStock_Load(object sender, EventArgs e)
        {
            if (Form1.lista_disponibles_stock.Any())
            {
                foreach (String[] n in Form1.lista_disponibles_stock)
                {
